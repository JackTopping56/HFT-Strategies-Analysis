...
QUERY = (
    'SELECT * FROM `lucky-science-410310.snp500_economic_indicator_data.snp500_ffr_data_raw`'
)
...
destination_table_id = 'lucky-science-410310.snp500_economic_indicator_data.snp500_ffr_data_clean'
